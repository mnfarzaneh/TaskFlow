...
class DeadlineWorker @AssistedInject constructor(
    ...
    override suspend fun doWork(): Result {
        ...
        showDeadlineNotification(taskId, taskTitle)
        return Result.success()
    }

    private fun showDeadlineNotification(taskId: Long, taskTitle: String) {
        ...
        val notification = NotificationCompat.Builder(context, CHANNEL_ID)
            ...
            .setContentText("وظیفه «$taskTitle» به زودی منقضی میشه")
